...
fun is_sound_direction (dx,dy) = dx>= ~1 andalso dx<=1 andalso dy>= ~1 andalso dy<=1 andalso if dx=0 then dy<>0 else true andalso if dy=0 then dx<>0 else true
