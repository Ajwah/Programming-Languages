...
f(#Spades number,60);
f(#Clubs number,50);
f(#Diamonds number,54);
f(#Hearts number,80) ;
f(#Spades honors,41);
f(#Clubs honors,42);
f(#Diamonds honors,40);
f(#Hearts honors,43);
f((Clubs,Queen)::(#Spades number),1);
f((Spades,Queen)::(#Clubs number),100) ;
f((Hearts,King)::(#Diamonds number),64);
f((Diamonds,King)::(#Hearts number),63);
f((Diamonds,King)::(#Spades honors),52);
f((Hearts,King)::(#Clubs honors),50);
f((Spades,Queen)::(#Diamonds honors),41) ;
f((Clubs,Queen)::(#Hearts honors),60);
f((#Spades number)@[(Diamonds,King)],64);
f((#Clubs number)@[(Hearts,King)],6);
f((#Diamonds number)@[(Spades,Queen)],24);
...
f([(Clubs, Ace)],1);
f([(Clubs, Num(~10))],10);
f([(Clubs,Ace),(Spades,Ace),(Clubs,Ace),(Spades,Ace)],42);
