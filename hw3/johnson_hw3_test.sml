...
val tests = [
    ...
    ("4.a.0 Empty List", longest_string3([]) = ""),
    ("4.a.10 One element List: Empty String", longest_string3([""]) = ""),
    ("4.a.11 One element List: one word", longest_string3(["test"]) = "test"),
    
    ("4.a.20 Two element List: Empty String", longest_string3(["",""]) = ""),
    ("4.a.21 Two element List: Empty String + one word", longest_string3(["","test"]) = "test"),
    ("4.a.22 Two element List: One word + Empty String", longest_string3(["test",""]) = "test"),
    ("4.a.23 Two element List: 2 Words: Longest first", longest_string3(["testTest","teSt"]) = "testTest"),
    ("4.a.24 Two element List: 2 Words: Shortest first", longest_string3(["test","testTest"]) = "testTest"),
    ("4.a.25 Two element List: 2 Words: Equal Length", longest_string3(["testTest1","testTest2"]) = "testTest1"),
    
    ("4.a.30 Three element List: 2*Empty String + Word at end", longest_string3(["","","Test"]) = "Test"),
    ("4.a.31 Three element List: 2*Empty String + Word at fron", longest_string3(["Test","",""]) = "Test"),
    ("4.a.32 Three element List: 2*Empty String + Word in middle", longest_string3(["","Test",""]) = "Test"),
    ("4.a.33 Three element List: 2*Short Word + Word at end", longest_string3(["est","sts","Test"]) = "Test"),
    ("4.a.34 Three element List: 2*Short Word + Word at fron", longest_string3(["Test","est","ste"]) = "Test"),
    ("4.a.35 Three element List: 2*Short Word + Word in middle", longest_string3(["ste","Test","est"]) = "Test"),
    ("4.a.36 Three element List: 2*Equal Long Word + Word in middle", longest_string3(["testTest1","Test","testTest2"]) = "testTest1"),
    
    ("4.a.40 Plenty element List: ALL equal length", longest_string3(["s6CmxYH9KAr","su40waWdFvM","s6CmxYH9KAr","sDW0wQKwWu7","sASt81VnTZY","sENkyvsBJf6","sfPvrv723iB","su40waWdFvM","sb9lgY0DxVo","sb9lgY0DxVo"]) = "s6CmxYH9KAr"),
    ("4.a.41 Plenty element List: ALL Different Length. Big To Small", longest_string3(["Cu40waWdFvM","CfPvrv723i","CfPvrv723","CfPvrv72","Cb9lgY0","CDKoLm","CDW0w","Cb9l","CDW","C1"]) = "Cu40waWdFvM"),
    ("4.a.42 Plenty element List: All Different Length. Small To Big", longest_string3(["E","1bX","u40","fPvr","DKoLm","b9lgY0","fPvrv72","ENkyvsBJ","u40waWdFv","u40waWdFvM"]) = "u40waWdFvM"),
    ("4.a.43 Plenty element List: All Different Length. Random", longest_string3(["E","DKoLm","b9lgY0","1bX","fPvr","u40waWdFvM","fPvrv72","ENkyvsBJ","u40","u40waWdFv"]) = "u40waWdFvM"),

    ("4.b.0 Empty List", longest_string4([]) = ""),
    ("4.b.10 One element List: Empty String", longest_string4([""]) = ""),
    ("4.b.11 One element List: one word", longest_string4(["test"]) = "test"),
    
    ("4.b.20 Two element List: Empty String", longest_string4(["",""]) = ""),
    ("4.b.21 Two element List: Empty String + one word", longest_string4(["","test"]) = "test"),
    ("4.b.22 Two element List: One word + Empty String", longest_string4(["test",""]) = "test"),
    ("4.b.23 Two element List: 2 Words: Longest first", longest_string4(["testTest","teSt"]) = "testTest"),
    ("4.b.24 Two element List: 2 Words: Shortest first", longest_string4(["test","testTest"]) = "testTest"),
    ("4.b.25 Two element List: 2 Words: Equal Length", longest_string4(["testTest1","testTest2"]) = "testTest2"),
    
    ("4.b.30 Three element List: 2*Empty String + Word at end", longest_string4(["","","Test"]) = "Test"),
    ("4.b.31 Three element List: 2*Empty String + Word at fron", longest_string4(["Test","",""]) = "Test"),
    ("4.b.32 Three element List: 2*Empty String + Word in middle", longest_string4(["","Test",""]) = "Test"),
    ("4.b.33 Three element List: 2*Short Word + Word at end", longest_string4(["est","sts","Test"]) = "Test"),
    ("4.b.34 Three element List: 2*Short Word + Word at fron", longest_string4(["Test","est","ste"]) = "Test"),
    ("4.b.35 Three element List: 2*Short Word + Word in middle", longest_string4(["ste","Test","est"]) = "Test"),
    ("4.b.36 Three element List: 2*Equal Long Word + Word in middle", longest_string4(["testTest1","Test","testTest2"]) = "testTest2"),
    
    ("4.b.40 Plenty element List: ALL equal length", longest_string4(["s6CmxYH9KAr","su40waWdFvM","s6CmxYH9KAr","sDW0wQKwWu7","sASt81VnTZY","sENkyvsBJf6","sfPvrv723iB","su40waWdFvM","sb9lgY0DxVo","sb9lgY0DxVo"]) = "sb9lgY0DxVo"),
    ("4.b.41 Plenty element List: ALL Different Length. Big To Small", longest_string4(["Cu40waWdFvM","CfPvrv723i","CfPvrv723","CfPvrv72","Cb9lgY0","CDKoLm","CDW0w","Cb9l","CDW","C1"]) = "Cu40waWdFvM"),
    ("4.b.42 Plenty element List: All Different Length. Small To Big", longest_string4(["E","1bX","u40","fPvr","DKoLm","b9lgY0","fPvrv72","ENkyvsBJ","u40waWdFv","u40waWdFvM"]) = "u40waWdFvM"),
    ("4.b.43 Plenty element List: All Different Length. Random", longest_string4(["E","DKoLm","b9lgY0","1bX","fPvr","u40waWdFvM","fPvrv72","ENkyvsBJ","u40","u40waWdFv"]) = "u40waWdFvM"),
    ...
    ("9d.1 ", count_some_var ("dates",Wildcard) = 0),
    ("9d.2 ", count_some_var ("dates",ConstP(3)) = 0),
    ("9d.3 ", count_some_var ("setad",UnitP) = 0),
    ("9d.4 ", count_some_var ("wert",TupleP[Wildcard,Variable("test"),Variable(""),Variable("dates"),ConstP(2),Variable("Wert")]) = 0),
    ("9d.5 ", count_some_var ("",TupleP[Wildcard,Variable("test"),Variable(""),Variable("dates"),ConstP(2),Variable("Wert")]) = 1),
    ("9d.6 ", count_some_var ("test",TupleP[Wildcard,Variable("test"),Variable(""),Variable("dates"),ConstP(2),Variable("Wert")]) = 1),
    ("9d.7 ", count_some_var ("Wert",TupleP[Wildcard,Variable("test"),Variable(""),Variable("dates"),ConstP(2),Variable("Wert")]) = 1),
    ("9d.8 ", count_some_var ("wert",TupleP[Wildcard,Variable("test"),Variable("wert"),Variable("dates"),ConstP(2),Variable("wert"),Wildcard,ConstructorP("wert",Wildcard),ConstructorP("wert",Variable("wert")),ConstructorP("test",Variable("wert"))]) = 4),

    ("10.0 ", check_pat(Wildcard) = false),
    ("10.1 ", check_pat(Variable("unique")) = true),
    ("10.2 ", check_pat(ConstP(3)) = false),
    ("10.3 ", check_pat(UnitP) = false),
    ("10.4 ", check_pat(TupleP[]) = false),
    ("10.5 ", check_pat(TupleP[Variable("unique"),Wildcard]) = true),
    ("10.6 ", check_pat(TupleP([Wildcard,UnitP])) = false),
    ("10.7 ", check_pat(TupleP([Wildcard,Wildcard,UnitP,Wildcard,Variable("Wildcard"),Wildcard,Wildcard,ConstP(2)])) = true),
    ("10.8 ", check_pat(ConstructorP("test",ConstructorP("test2",TupleP[Wildcard,Wildcard,UnitP,Wildcard,Variable("Wildcard"),Wildcard,Wildcard,ConstP(2)]))) = true),
    ("10.9 ", check_pat(TupleP([Variable("Test1"),Variable("Test2")])) = true),
    ("10.10 ", check_pat(TupleP([Variable("Test1"),Wildcard,Variable("Test2")])) = true),
    ("10.11 ", check_pat(TupleP([Variable("Test1"),ConstructorP("Wildcard",Wildcard),Variable("Test2")])) = true),
    ("10.12 ", check_pat(ConstructorP("Test",TupleP([Variable("duplicate"),TupleP([ConstructorP("test2",Variable("duplicate")),Variable("unique"),Variable("qwerty")])]))) = false),
    ("10.13 ", check_pat(ConstructorP("sdfs",TupleP([Variable("A"),Variable("B"),ConstP(4),TupleP[Variable("C"),ConstructorP("sds",UnitP)],ConstructorP("dfg",TupleP[Variable("D"),Variable("E"),ConstP(4)])]))) = true)    
];
