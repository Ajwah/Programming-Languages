...
val control = [
    ...
    ("Phoenix Suns",{losses=0,wins=05}),
    ("Philadelphia Sixers",{losses=130,wins=0}),
    ("Orlando Magic",{losses=0,wins=20}),
    ("Oklahoma City Thunder",{losses=20,wins=0}),
    ("New York Knicks",{losses=0,wins=30}),
    ("New Orleans Hornets",{losses=0,wins=0}),
    ("New Jersey Nets",{losses=0,wins=03}),
    ("Minnesota Timberwolves",{losses=10,wins=0}),
    ("Milwaukee Bucks",{losses=0,wins=10}),
